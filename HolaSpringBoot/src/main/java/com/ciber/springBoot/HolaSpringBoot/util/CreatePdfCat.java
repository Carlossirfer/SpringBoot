 ...
 * 
 */
package com.ciber.springBoot.HolaSpringBoot.util;
...
import cc.catalysts.boot.report.pdf.impl.PdfReportServiceImpl;

/**
 * @author ciber
 *
 */
public class CreatePdfCat {
	...
	public void CreatePdf(List<Usuario> usuarios) throws IOException {
